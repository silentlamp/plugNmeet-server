...
## [3.0.0](https://github.com/silentlamp/plugNmeet-server/compare/v2.3.0...v3.0.0) (2026-07-14)
...
* ability to download transcription in vtt format ([bab5746](https://github.com/silentlamp/plugNmeet-server/commit/bab5746c161da3349b0e358e33e242ca16a2640f))
* add emoji reaction ([575bf5e](https://github.com/silentlamp/plugNmeet-server/commit/575bf5e3769129a972adf63d562b01c154fcd986))
* add emoji reaction ([09713b1](https://github.com/silentlamp/plugNmeet-server/commit/09713b11ac086159ae58ea6d65b2eb02211ebd1d))
* added more details proxy config based on fiber v3 + prometheus basic auth ([a864a9d](https://github.com/silentlamp/plugNmeet-server/commit/a864a9d7ed3ff00adbe6819a7b5b879b51953221))
* added new API `BroadcastToRoom` ([203e950](https://github.com/silentlamp/plugNmeet-server/commit/203e95009149ff596363dfae634ad9a5232390e4))
* added new API `BroadcastToRoom` ([b925d24](https://github.com/silentlamp/plugNmeet-server/commit/b925d24e842c6504ebdc55909828d7fdb0231595))
* added new API endpoint `uploadWhiteboardFile` ([95173fb](https://github.com/silentlamp/plugNmeet-server/commit/95173fb3fea5f0358470aae8f7d56d12d5b66562))
* added new API endpoint `uploadWhiteboardFile` ([3474ee8](https://github.com/silentlamp/plugNmeet-server/commit/3474ee8c8e95345bfcf2b99c92c3b272cc4f7592))
* added recorder bot controlling options ([ec5dc97](https://github.com/silentlamp/plugNmeet-server/commit/ec5dc9726c7e86949a35def7bc111ccbccdd6943))
* allow to use direct link as `document_link` for `uploadWhiteboardFile` as well ([4c91bd4](https://github.com/silentlamp/plugNmeet-server/commit/4c91bd492929661d67f5b687354cfc7f2f544dfd))
* **API:** added merge recordings API ([753f51e](https://github.com/silentlamp/plugNmeet-server/commit/753f51e1726c59ac3214fffb6a628266330a31b9))
* **app:** serve meeting SPA for ZenLeader room-code paths ([fbc289d](https://github.com/silentlamp/plugNmeet-server/commit/fbc289d7b424ae1bf44fb490265ccda47fc6eaf7))
* **app:** serve SPA for ZenLeader room-code share paths ([1809ff3](https://github.com/silentlamp/plugNmeet-server/commit/1809ff374b374eccf952511ec0b919312191ad9d))
* **branding:** ZenLeader copyright defaults and portal /login redirect ([39991af](https://github.com/silentlamp/plugNmeet-server/commit/39991afe723bc18fa61499dcdaad2654c1294d99))
* breaking changes in new UI + API ([e637442](https://github.com/silentlamp/plugNmeet-server/commit/e63744216cda41c92192c84f8c7449289bcba1dc))
* chat with AI ([13ede93](https://github.com/silentlamp/plugNmeet-server/commit/13ede937c144f772d5fed9ba033819b27ab1f3bf))
* DB auto migration ([c66f2ba](https://github.com/silentlamp/plugNmeet-server/commit/c66f2baf790e304667e03ce2096e3684046c41ae))
* estimated cost calculation ([0b48530](https://github.com/silentlamp/plugNmeet-server/commit/0b485303766be50cee9218c83850c1548d4a05e9))
* Insights framework ([5b35582](https://github.com/silentlamp/plugNmeet-server/commit/5b355825c52ead3bbfb7f939dd5d6a60b9836df0))
* meeting summerization ([53985c9](https://github.com/silentlamp/plugNmeet-server/commit/53985c9eaae0372d33df0e9eb0e7cc0d74e9d934))
* migrate project from `google wire` to `uber fx` ([e191e38](https://github.com/silentlamp/plugNmeet-server/commit/e191e38aa3c6b17098f31f5597a635adaf1e2e4f))
* migrate project from `google wire` to `uber fx` ([7e591f1](https://github.com/silentlamp/plugNmeet-server/commit/7e591f13885154331e5ba8c3cf59bdf1a80d17a5))
* **recording:** recording metadata ([404de39](https://github.com/silentlamp/plugNmeet-server/commit/404de3956ae7496b6a2c1cabc7a25009d03a7ccd))
* server config option to enable/disable `insights` ([e8808c5](https://github.com/silentlamp/plugNmeet-server/commit/e8808c59ec50a2241a96bf3927cd1adf6a7ebaf2))
* set raised-hand timestamp on raise/lower ([92aa317](https://github.com/silentlamp/plugNmeet-server/commit/92aa3172b35ac0314fc41695da30f67180f3b2e5))
* set raised-hand timestamp on raise/lower ([5cb09ba](https://github.com/silentlamp/plugNmeet-server/commit/5cb09ba1c6ef255b0fbe852f4c6bfedcad3e1c85))
* SIP dial in ([4d6e3bf](https://github.com/silentlamp/plugNmeet-server/commit/4d6e3bf455bb6ebc93e812898bc0f0b6affbcfbc))
* SIP dial in ([ede2dda](https://github.com/silentlamp/plugNmeet-server/commit/ede2dda4e652c93925fa43d350c8aa82c6119ea0))
* storage hook ([5f9f23b](https://github.com/silentlamp/plugNmeet-server/commit/5f9f23b215f88762e6c9da26dbcf7c4e298eb38c))
* storage hook ([55ad7a7](https://github.com/silentlamp/plugNmeet-server/commit/55ad7a7e4892da64c0db33e006bb1484c16d688d))
* **whiteboard:** export to PDF ([4f08913](https://github.com/silentlamp/plugNmeet-server/commit/4f089138035efce565a5b40c7a99f8a434f740ba))
* **whiteboard:** export to PDF ([f3360ac](https://github.com/silentlamp/plugNmeet-server/commit/f3360ac32d71ba562e885cd74ea7ecfe5ef6491b))


### Bug Fixes

* `MergeRecordingsReq` now support roomId as well ([00ff03a](https://github.com/silentlamp/plugNmeet-server/commit/00ff03a2599ec6dcc3dd319fb74d6a2179b3b01c))
* acquire lock as soon as request arrive ([6bbae57](https://github.com/silentlamp/plugNmeet-server/commit/6bbae5766391babaa0a4b64c5c020fc8ac9dbff7))
* add base docker for faster build ([9dd5ee6](https://github.com/silentlamp/plugNmeet-server/commit/9dd5ee666cceef8c80b6a28e03163c1d7768b36f))
* added `HEAD` as `AllowMethods` ([52169a0](https://github.com/silentlamp/plugNmeet-server/commit/52169a0d49607098f98176ddc23388b3360228a7))
* added better way to download file ([34edd65](https://github.com/silentlamp/plugNmeet-server/commit/34edd65d63e2bb68941c592febc1851d94f60e0c))
* added comments and renamed methods ([b8298f6](https://github.com/silentlamp/plugNmeet-server/commit/b8298f66f19f9663e914a1535e90268b53d746b0))
* added description for easy understanding ([b67219f](https://github.com/silentlamp/plugNmeet-server/commit/b67219fb00a4ab1cea7ec76cadda5832b68224eb))
* added missing context ([933fd13](https://github.com/silentlamp/plugNmeet-server/commit/933fd13247ec61922821ae26699d2fe8c294d402))
* added new `max_preloaded_wb_file_size` config option ([a1fb850](https://github.com/silentlamp/plugNmeet-server/commit/a1fb850820889d370d8360134751c57e3a4527d5))
* added option to set CDN url for static_assets_path ([8b7a41a](https://github.com/silentlamp/plugNmeet-server/commit/8b7a41a38ff725f737025f9ae8ed00a6f1b40dcc))
* added option to set hook timeout ([ace1894](https://github.com/silentlamp/plugNmeet-server/commit/ace18940db88e48d480ecb34c7077048c6d33363))
* added status code in auth related response ([c5a9f5f](https://github.com/silentlamp/plugNmeet-server/commit/c5a9f5f8278b179a6696c7fb48d3beb5ecc0928d))
* added/clean logs ([d6366ec](https://github.com/silentlamp/plugNmeet-server/commit/d6366ec67ac849d10d79958c02014226dec14e77))
* adding missing cast conversion ([f3e1861](https://github.com/silentlamp/plugNmeet-server/commit/f3e18617a28be140120afd49c1849582f3cf240a))
* adjusted time ([c05e5b3](https://github.com/silentlamp/plugNmeet-server/commit/c05e5b343a87aad200e023b743e7edb294b677aa))
* adjusted with new API ([ddde79e](https://github.com/silentlamp/plugNmeet-server/commit/ddde79e9a5a26f81c17279928fe7ffd88abd7a5d))
* adjusted with new options ([97bd547](https://github.com/silentlamp/plugNmeet-server/commit/97bd547b42f9283a467630f98bd9e169f68424ff))
* adopt idiomatic fx for dependency management ([3a8394f](https://github.com/silentlamp/plugNmeet-server/commit/3a8394f42fa8d9eff9534be5c52c35b6c8b7e032))
* **api:** prevent to list without roomId or roomSid ([4c3b60e](https://github.com/silentlamp/plugNmeet-server/commit/4c3b60e41564852e699298b6926ac880a7ceeecd))
* **app:** use Fiber v3 Redirect API for portal /login ([2a7d50a](https://github.com/silentlamp/plugNmeet-server/commit/2a7d50a544007ce1938533d84725ddf3c1639cd4))
* backed previous value will delete upcoming releases ([720de60](https://github.com/silentlamp/plugNmeet-server/commit/720de60255bf2f8b90b5090b1fb553215c9b9936))
* better error handling ([d6f6232](https://github.com/silentlamp/plugNmeet-server/commit/d6f623273b65bfb5282ea98d5fcceb7a2e6b94ca))
* **branding:** use English Blue Ocean Digital copyright text ([5945d90](https://github.com/silentlamp/plugNmeet-server/commit/5945d90ffb86a36a594dbc44f17f6e5e6557238f))
* bug fix and improved LTI ([42d25cc](https://github.com/silentlamp/plugNmeet-server/commit/42d25cc1e7d3404d9ea899871f4d34056aeddf44))
* bug in updating lock ([777cc9d](https://github.com/silentlamp/plugNmeet-server/commit/777cc9dac0d455c802597de06e62dc5f9d15bd44))
* bug regarding `enabled_self_insert_encryption_key` ([cc55908](https://github.com/silentlamp/plugNmeet-server/commit/cc559083f779b2810de74f88091d09e1c8e2d685))
* bump actions ([3b067ee](https://github.com/silentlamp/plugNmeet-server/commit/3b067ee7fbf92cbccf633dc9282a8a651936033a))
* bump deps ([7948141](https://github.com/silentlamp/plugNmeet-server/commit/7948141d1d8fc90ac53910622b489753b396358b))
* bump deps ([d0809a1](https://github.com/silentlamp/plugNmeet-server/commit/d0809a1e2016fde2a1d0ff74de654c6cbd052788))
* bump deps ([9626944](https://github.com/silentlamp/plugNmeet-server/commit/9626944c38e80884565dd534040bf050df264963))
* bump deps ([35d5d35](https://github.com/silentlamp/plugNmeet-server/commit/35d5d3574d04988bcfcec26536c5c458d04aaada))
* bump deps ([7945378](https://github.com/silentlamp/plugNmeet-server/commit/7945378b906e9b9dd07ff1188951a5aeaa848f05))
* bump deps ([62fd2ca](https://github.com/silentlamp/plugNmeet-server/commit/62fd2caa1ba203b32b716ffaded97b6d25eb4178))
* bump proto ([bc5bbac](https://github.com/silentlamp/plugNmeet-server/commit/bc5bbac3b17251b6340b20915b9b2be17f2cee91))
* bump proto ([da564ba](https://github.com/silentlamp/plugNmeet-server/commit/da564ba44edc66e61f0545627fe0a8b0d78ca041))
* bump proto ([bd817d1](https://github.com/silentlamp/plugNmeet-server/commit/bd817d19e51d5153674253dc3c518f21edf34607))
* bump proto ([57345c7](https://github.com/silentlamp/plugNmeet-server/commit/57345c7839378cd6a24be15f3ade8529b4cc1dcd))
* bump proto ([9475dec](https://github.com/silentlamp/plugNmeet-server/commit/9475decaadefe211872befb9bee4b6c13ae8dcbe))
* bump to go `1.26` ([30e02b7](https://github.com/silentlamp/plugNmeet-server/commit/30e02b7dab973fce72b434044db37684d16aedc4))
* check pipeline first and fallback to default path ([7542b78](https://github.com/silentlamp/plugNmeet-server/commit/7542b780756772775751194e1cb143736a34d303))
* check status immediately after calling ([8fc8521](https://github.com/silentlamp/plugNmeet-server/commit/8fc8521ba2038467705180a5c3fe229c067d0402))
* clean + re-arranged code ([81fb5ee](https://github.com/silentlamp/plugNmeet-server/commit/81fb5ee612bdc1ede8ab7b62d0c924b2961c9b0a))
* clean up + bump proto ([dca96b0](https://github.com/silentlamp/plugNmeet-server/commit/dca96b075f1f5c72dee38aadb12812e1d16a4620))
* clean up code ([e1df472](https://github.com/silentlamp/plugNmeet-server/commit/e1df472feb57fd295ad655920475715f9e1fe49c))
* clean up ProcessRecorderEvent ([b39d712](https://github.com/silentlamp/plugNmeet-server/commit/b39d712b2e41a54179e05c4a144fd5998cae6d38))
* cleaned up + merged ([c5654d5](https://github.com/silentlamp/plugNmeet-server/commit/c5654d575aa10acec2946adf91a98abd8917a3c9))
* cleaned up + merged ([5f37afe](https://github.com/silentlamp/plugNmeet-server/commit/5f37afe1e97d6e1393f2cdec00d215246e106f48))
* cleaned up confused code ([9006f9b](https://github.com/silentlamp/plugNmeet-server/commit/9006f9b434b32ab62a57dbed59a16658e066d048))
* cleaning up ([99ace5d](https://github.com/silentlamp/plugNmeet-server/commit/99ace5d64574e0d9684427166a89f1359f49eb14))
* clear logs ([a8fee75](https://github.com/silentlamp/plugNmeet-server/commit/a8fee75617b9a1ea3deb43fe2d9bcb7af23becfe))
* configurable option to `fallback_turn` when connection bad ([e05b55e](https://github.com/silentlamp/plugNmeet-server/commit/e05b55e1a1b02952c12de9065486264186c09a87))
* confusing log was displaying ([6f420ce](https://github.com/silentlamp/plugNmeet-server/commit/6f420cee9c6176ae3be14696780100ce9e01dac9))
* connection provider should use self-closing ([fbbe6b8](https://github.com/silentlamp/plugNmeet-server/commit/fbbe6b8d24b2c88d052d230cb426086c7721cd21))
* consider CPU usage during selecting recorder ([cc9870a](https://github.com/silentlamp/plugNmeet-server/commit/cc9870aaaece04a72c23fda608c8304f2848543f))
* context was canceled before publishing ([a5c6ebf](https://github.com/silentlamp/plugNmeet-server/commit/a5c6ebf4c764384aecbdf8b8b28e17c658af57fe))
* **critical:** duplicate event was sending because of using same subject for both JS and Core pub/sub ([83c0535](https://github.com/silentlamp/plugNmeet-server/commit/83c053590bf3946e4ea76dae86a8a594d4486c8a))
* data race ([833dde2](https://github.com/silentlamp/plugNmeet-server/commit/833dde2a3bd78c27f72912e400be5b03c6ee8c24))
* db counter should update when user conncted/disconncted ([b09d589](https://github.com/silentlamp/plugNmeet-server/commit/b09d589d04dd4c111042f45365a5884ddde1edbe))
* delay end to avoid race condition ([8d41272](https://github.com/silentlamp/plugNmeet-server/commit/8d41272aa20f461b525154c9356d29a8bb8f5147))
* deliver private messages routed by server through private channel ([e638788](https://github.com/silentlamp/plugNmeet-server/commit/e6387888f3257169dfa770e658a4108ad2e9bd35))
* dependencies update ([5017670](https://github.com/silentlamp/plugNmeet-server/commit/5017670fdee65f8a93e892055c291ea51e625a2a))
* **deps:** update module buf.build/go/protovalidate to v1.1.2 ([79b81ad](https://github.com/silentlamp/plugNmeet-server/commit/79b81ad221320efb25e2495d095c051ff483562c))
* **deps:** update module buf.build/go/protovalidate to v1.1.2 ([04a2ec7](https://github.com/silentlamp/plugNmeet-server/commit/04a2ec7a132ac75f09f78e155805bee2ff5cab9f))
* **deps:** update module buf.build/go/protovalidate to v1.1.3 ([541ac68](https://github.com/silentlamp/plugNmeet-server/commit/541ac684b0f23b38afecfc6e2a707e3aa82071fa))
* **deps:** update module buf.build/go/protovalidate to v1.1.3 ([82a259a](https://github.com/silentlamp/plugNmeet-server/commit/82a259ab1fbf9c07b26a206aa8f7b6885bb286ca))
* **deps:** update module github.com/gabriel-vasile/mimetype to v1.4.13 ([cdfeae1](https://github.com/silentlamp/plugNmeet-server/commit/cdfeae1c14a3b75674e9a18906e154bd05b091f4))
* **deps:** update module github.com/gabriel-vasile/mimetype to v1.4.13 ([b5102dc](https://github.com/silentlamp/plugNmeet-server/commit/b5102dcbec60e39b9abd5385785eeb0ca3ce69b7))
* **deps:** update module github.com/go-jose/go-jose/v4 to v4.1.4 [security] ([0db6d9b](https://github.com/silentlamp/plugNmeet-server/commit/0db6d9b9f7683d2213e29b4b0939d36257549a2b))
* **deps:** update module github.com/go-jose/go-jose/v4 to v4.1.4 [security] ([24ccdb4](https://github.com/silentlamp/plugNmeet-server/commit/24ccdb4638f322b52c5145b5fd310285f86bd226))
* **deps:** update module github.com/goccy/go-json to v0.10.6 ([a44ef26](https://github.com/silentlamp/plugNmeet-server/commit/a44ef262ffb844f1b641822682a37bda136fb5be))
* **deps:** update module github.com/goccy/go-json to v0.10.6 ([f7baa2b](https://github.com/silentlamp/plugNmeet-server/commit/f7baa2b4d8f0959af3c6b3a50e3773f4bc3f11a4))
* **deps:** update module github.com/gofiber/fiber/v2 to v2.52.11 [security] ([1916cca](https://github.com/silentlamp/plugNmeet-server/commit/1916cca89a9d835b0e327b9403a1402f7a13398a))
* **deps:** update module github.com/gofiber/fiber/v2 to v2.52.11 [security] ([cb3b3b3](https://github.com/silentlamp/plugNmeet-server/commit/cb3b3b36f30cd00e064e17e36e92ab5847d1ef88))
* **deps:** update module github.com/gofiber/fiber/v2 to v2.52.12 [security] ([736860a](https://github.com/silentlamp/plugNmeet-server/commit/736860af443ef30e304e44d54af89bc3d1cb6304))
* **deps:** update module github.com/gofiber/fiber/v2 to v2.52.12 [security] ([d39747d](https://github.com/silentlamp/plugNmeet-server/commit/d39747db851549642d663a417b6d8248d609a8f2))
* **deps:** update module github.com/livekit/server-sdk-go/v2 to v2.13.3 ([e81330b](https://github.com/silentlamp/plugNmeet-server/commit/e81330b366b5c310b16480a9a7494a1f5030b9b8))
* **deps:** update module github.com/livekit/server-sdk-go/v2 to v2.13.3 ([b2432a6](https://github.com/silentlamp/plugNmeet-server/commit/b2432a681a374edac0fd6399d87652ee7b52456b))
* **deps:** update module github.com/microsoft/cognitive-services-speech-sdk-go to v1.48.2 ([cf84a12](https://github.com/silentlamp/plugNmeet-server/commit/cf84a12a9b0d0dc27718c6fb1f0cb361819ee3e5))
* **deps:** update module github.com/microsoft/cognitive-services-speech-sdk-go to v1.48.2 ([3e41609](https://github.com/silentlamp/plugNmeet-server/commit/3e41609ec0b17bba2d4721ba1293bff6d2ee93b2))
* **deps:** update module github.com/microsoft/cognitive-services-speech-sdk-go to v1.49.0 ([90ae974](https://github.com/silentlamp/plugNmeet-server/commit/90ae97444412289207664b505ac24b0e58d555d9))
* **deps:** update module github.com/microsoft/cognitive-services-speech-sdk-go to v1.49.0 ([56566d8](https://github.com/silentlamp/plugNmeet-server/commit/56566d86955cc986cb7e351e3228c497ba117258))
* **deps:** update module github.com/redis/go-redis/v9 to v9.17.3 ([7127d3f](https://github.com/silentlamp/plugNmeet-server/commit/7127d3fadd338faab3f7d66b043e29f8e5542892))
* **deps:** update module github.com/redis/go-redis/v9 to v9.17.3 ([4f90208](https://github.com/silentlamp/plugNmeet-server/commit/4f90208b93684e2beba8e59d9f3c7b96b8261919))
* **deps:** update module google.golang.org/genai to v1.43.0 ([f74048b](https://github.com/silentlamp/plugNmeet-server/commit/f74048b496565072f015d24c518df117ff5e8cfd))
* **deps:** update module google.golang.org/genai to v1.43.0 ([0b9e613](https://github.com/silentlamp/plugNmeet-server/commit/0b9e61394feece5e5f6745b5f91d20bc46b551db))
* **deps:** update module google.golang.org/genai to v1.53.0 ([c94f417](https://github.com/silentlamp/plugNmeet-server/commit/c94f41793ffc7502a3ee3553920c7b90f908acbf))
* **deps:** update module google.golang.org/genai to v1.53.0 ([ba3d28e](https://github.com/silentlamp/plugNmeet-server/commit/ba3d28e7e95705876a528f6ee417da26d5891159))
* detect error if any, during initialization ([ae17b3f](https://github.com/silentlamp/plugNmeet-server/commit/ae17b3f319595b15d86bc15b4d3b51c909c173b4))
* dir navigation problem ([cd2f301](https://github.com/silentlamp/plugNmeet-server/commit/cd2f30117189990a89c94795e37184d907cb331b))
* disable features when `SelfInsertEncryptionKey` enabled ([6633cb2](https://github.com/silentlamp/plugNmeet-server/commit/6633cb24ece714549d79f2c69e4cb0ed6a23dd52))
* docker dev build ([8651446](https://github.com/silentlamp/plugNmeet-server/commit/8651446e85742d88b2a9f3eb2120599d7c81e61a))
* docker run ([b4cf071](https://github.com/silentlamp/plugNmeet-server/commit/b4cf071d9b64412493a819fa57a141bd262f8287))
* don't check `ContentLength` if server didn't set it, need to check after download ([e0888fb](https://github.com/silentlamp/plugNmeet-server/commit/e0888fba22876138cd8d773eeba2ead135c7ac4f))
* don't send raw error message to client ([7e499b1](https://github.com/silentlamp/plugNmeet-server/commit/7e499b1d6a40812ce28649ae04c7e0ed217e67ea))
* don't trigger for internal ([eb67710](https://github.com/silentlamp/plugNmeet-server/commit/eb67710aeae6302b8f4133e7f9cfcc1c492bced5))
* ensure file names are unique and following same format ([ebdbfc4](https://github.com/silentlamp/plugNmeet-server/commit/ebdbfc4ebb0030963596c81ac33edb4ba210d409))
* ensure max 64 characters ([dace4f2](https://github.com/silentlamp/plugNmeet-server/commit/dace4f2b371470d9ab2a51c3c11901e18ecdb530))
* ensure we're in the right dir e.g. `/app` ([c745978](https://github.com/silentlamp/plugNmeet-server/commit/c745978d894d478f5fa0e9155feb00df3a5697b6))
* fallback to default ([86c4839](https://github.com/silentlamp/plugNmeet-server/commit/86c483995cf2ea5d97d88c4c549c69c172d1db5e))
* fallback to redis cache ([f8d1766](https://github.com/silentlamp/plugNmeet-server/commit/f8d1766a5d73693883ced8a4f698587682c9e04e))
* fallback watching with `GetUserInfo` as well ([98c3006](https://github.com/silentlamp/plugNmeet-server/commit/98c300637bb6a70e22a89b95528989b1b5f9b8b2))
* fast url validation ([6c715d5](https://github.com/silentlamp/plugNmeet-server/commit/6c715d5c4886650cf98ea11b24cdf90167023432))
* **feat:** new option `fallback_on_flapping` for turn server ([033cb4a](https://github.com/silentlamp/plugNmeet-server/commit/033cb4ab4e5ba5e74c62b0f9d89f57c9e31c2918))
* **feat:** option to auto download client ([22449f1](https://github.com/silentlamp/plugNmeet-server/commit/22449f159f6e98c157644a507e34785c2c93fbb5))
* **feat:** option to configure custom turn servers ([1fc45a7](https://github.com/silentlamp/plugNmeet-server/commit/1fc45a75ebe19c669b78f398a5ba399f7801ef22))
* **feat:** option to configure custom turn servers ([1cd9b65](https://github.com/silentlamp/plugNmeet-server/commit/1cd9b6592aa99760d643a82bc912f2f8ecd5a19e))
* **feat:** storage hooks ([8aaf82d](https://github.com/silentlamp/plugNmeet-server/commit/8aaf82d3fe394e01be1c691cecaf237a09f980c8))
* **feat:** storage hooks ([f1e5925](https://github.com/silentlamp/plugNmeet-server/commit/f1e5925d26a069aac58ea527664178388b19e379))
* **feature:** implemented PONG from server to client to detect backend server's responsiveness ([c0cb832](https://github.com/silentlamp/plugNmeet-server/commit/c0cb83227d563eb8f24f79288231bbf4575e15de))
* few clean up ([c943220](https://github.com/silentlamp/plugNmeet-server/commit/c943220a0a58dfbfc093884379fbbd2ccb059609))
* handle conversion in a separate goroutine ([f7fa998](https://github.com/silentlamp/plugNmeet-server/commit/f7fa998c71cc9c80309e6b8729ae35ed77585400))
* handle correctly with recording metadata ([b1a1c91](https://github.com/silentlamp/plugNmeet-server/commit/b1a1c9136bcf00f0c9da893960a66b62902ae521))
* handle user disconnection more efficiently ([87f8a27](https://github.com/silentlamp/plugNmeet-server/commit/87f8a2718b203d58018ef1f30009dca71b7ebd45))
* **hooks:** use same pattern for communicating with hooks scripts ([336f0d0](https://github.com/silentlamp/plugNmeet-server/commit/336f0d04b18e804cdf9ad92111e5d6276d353513))
* implemented hook for all types file operation ([6305d3f](https://github.com/silentlamp/plugNmeet-server/commit/6305d3fbfa745a631511224edc2de26ab31f527d))
* implemented long-lived hook ([ed62106](https://github.com/silentlamp/plugNmeet-server/commit/ed62106c855fa66afeccb31d3478949857fc18d3))
* improve file upload/download ([2ac8125](https://github.com/silentlamp/plugNmeet-server/commit/2ac81251a5a6476d6db8841801afd63182f15120))
* incorrect path problem ([375fb1f](https://github.com/silentlamp/plugNmeet-server/commit/375fb1f8897af9669ae20f03449e5c2a8415176a))
* install curl ([18f176c](https://github.com/silentlamp/plugNmeet-server/commit/18f176cd0d91329fc20323c66fce87077722c63b))
* invalid status code was added ([604a44c](https://github.com/silentlamp/plugNmeet-server/commit/604a44c44bd71b4dd21012ca88c3ddd4836cc79d))
* invalid status code was returning ([7409152](https://github.com/silentlamp/plugNmeet-server/commit/7409152a53cd58a5e2856c339ebc09f2350bd07a))
* just for safety although strickly controlled by caller ([2e7569f](https://github.com/silentlamp/plugNmeet-server/commit/2e7569fc79e560c3de0f4e8ed3a48b6b679968f9))
* keep host-disconnect rooms alive and ignore unknown LiveKit webhooks ([07941a7](https://github.com/silentlamp/plugNmeet-server/commit/07941a73f5114ef7ccb3fb9c670b8599709ddef4))
* language segment ([f3fe1d0](https://github.com/silentlamp/plugNmeet-server/commit/f3fe1d07f6ec972f6b49a0551ee15d5e032b254e))
* lk logging issue + bump SDK ([4003f28](https://github.com/silentlamp/plugNmeet-server/commit/4003f28494238fe9b8cd562e8877c4ea06727287))
* lock to prevent duplicate task while another is processing ([e89604a](https://github.com/silentlamp/plugNmeet-server/commit/e89604a8ba5c852c6a66500e72e9ff305f1e8251))
* log duration took ([3c670b0](https://github.com/silentlamp/plugNmeet-server/commit/3c670b01085a6bff1e0fcbe6890faefe55d16b38))
* **LTI:** build URL correct way ([4e012f3](https://github.com/silentlamp/plugNmeet-server/commit/4e012f34ab0ff0f206180805528758ee2e3689c6))
* mask phone number in proper way ([0f39025](https://github.com/silentlamp/plugNmeet-server/commit/0f39025cab3ef3d13128a1e53d58957fbf318986))
* meeting summary webhook wasn't sending ([a3c6389](https://github.com/silentlamp/plugNmeet-server/commit/a3c63898c542f47d02ee08e8644623a53f4422b6))
* merged `ExternalDisplayLink` ([d707169](https://github.com/silentlamp/plugNmeet-server/commit/d707169bf110500458490c660eab4a403f17fba2))
* merged `ExternalMediaPlayer` ([498c313](https://github.com/silentlamp/plugNmeet-server/commit/498c313180a3f5995c131226d44846f4c9170953))
* merged `recorder` ([0f5a677](https://github.com/silentlamp/plugNmeet-server/commit/0f5a677207f89dc454985fa7205251ce950c48ea))
* merged `room duration` ([37ecb23](https://github.com/silentlamp/plugNmeet-server/commit/37ecb23fe0fc15692e7bf0843352f7165bd15264))
* merged `RoomDuration` ([8b67809](https://github.com/silentlamp/plugNmeet-server/commit/8b67809b8bdfe934b86937191653c594b61c3236))
* merged `waiting room` ([6dab935](https://github.com/silentlamp/plugNmeet-server/commit/6dab9352c9ecbaa458f4bd18006dfa2765f7cc65))
* merged blocklist into user's field ([3688d2d](https://github.com/silentlamp/plugNmeet-server/commit/3688d2db69395082a49d2469ca9ea13fb42dac7d))
* migrate chat to core pub/sub ([fa6fbae](https://github.com/silentlamp/plugNmeet-server/commit/fa6fbaed151374c49cd5ac815fc817a6bb110c21))
* migrate insights `SummarizeJobQueue` to NATS stream ([362bf35](https://github.com/silentlamp/plugNmeet-server/commit/362bf355c92d976c19db72c3d460dae767716a4a))
* migrate manual worker pool to `gammazero/workerpool` ([6f5d5ad](https://github.com/silentlamp/plugNmeet-server/commit/6f5d5add048b4071ba723daf19473f6dda35c7e8))
* migrated breakout rooms stats in redis ([b4ed045](https://github.com/silentlamp/plugNmeet-server/commit/b4ed0459e112c1b564b3e08b74ee2fc0543c7d9e))
* migrated into redis as nats KV TTL seems not working properly ([edd565a](https://github.com/silentlamp/plugNmeet-server/commit/edd565afd747c4b4d53012b6ad35e1f429cbc60f))
* migrated webhookData in redis ([ac666e6](https://github.com/silentlamp/plugNmeet-server/commit/ac666e6729d25e2d84d1ae3318a51283af1352fa))
* more verification before getting from cache ([3782da1](https://github.com/silentlamp/plugNmeet-server/commit/3782da13f97ef30503aca9b38bc30b45c6c3f7a0))
* moved `raised_hand` to its own `UserRaisedHand` message ([3c9519e](https://github.com/silentlamp/plugNmeet-server/commit/3c9519ef68ac6277549a2edbbafe6e57a81f7f3f))
* moved `to_user_id` to root ([5886163](https://github.com/silentlamp/plugNmeet-server/commit/5886163d071a20e1f2293c9f57935ea20795b9d3))
* moved cache under NATS service to manage ([e999355](https://github.com/silentlamp/plugNmeet-server/commit/e99935550163b1d9abd6b200ad003978fe8d2b2b))
* moved connection related logic to single file ([a4941c5](https://github.com/silentlamp/plugNmeet-server/commit/a4941c5f43131eaed021f3284624372316650002))
* moved default values to proto ([b56f5ca](https://github.com/silentlamp/plugNmeet-server/commit/b56f5cac70748dc6a83a2d3d0348087a690ae667))
* moved some other deps part to base ([c86d69f](https://github.com/silentlamp/plugNmeet-server/commit/c86d69fca4aba4633af2c797e2a50a29ce1f2bfd))
* must need to use `strings.Contains` for header matching ([402c6b2](https://github.com/silentlamp/plugNmeet-server/commit/402c6b20df9d96668e00084c9d88fd3c985d711b))
* nats connection tag name ([5cb471b](https://github.com/silentlamp/plugNmeet-server/commit/5cb471b97ca119c9a7b4866b8784048cf8ab4f65))
* nats optimisation ([5c8e3a6](https://github.com/silentlamp/plugNmeet-server/commit/5c8e3a654bb598b75debb5cf52c8699197c57f24))
* nats optimisation ([220bfb0](https://github.com/silentlamp/plugNmeet-server/commit/220bfb07c9f528a53dcdad737ccbcfa289d4141b))
* **nats:** Implemented new system pub/sub core channel and moved `sendAnalyticsData` to use it. ([75e41a2](https://github.com/silentlamp/plugNmeet-server/commit/75e41a22215d36df5e34fef44764d8657bb1b726))
* optimized `WebhookNotifier` ([c51f3e7](https://github.com/silentlamp/plugNmeet-server/commit/c51f3e7168d32f2f0345e7a318484b2f7ee1fda7))
* optimized KV for `etherpad` ([baef5eb](https://github.com/silentlamp/plugNmeet-server/commit/baef5ebf911f4f953a671c0f66c984e0935ff333))
* optimized KVs ([d354aaf](https://github.com/silentlamp/plugNmeet-server/commit/d354aafa9f9ab9eec96d69646887654d77e34783))
* optimized query code ([371e8eb](https://github.com/silentlamp/plugNmeet-server/commit/371e8eb27657a3744bb74b4bac46a3752fa48f02))
* option to set `fallbackTimerDuration` in server config ([a58048a](https://github.com/silentlamp/plugNmeet-server/commit/a58048a109b7de04c68f06343c54c9dada482eb9))
* organized nats KV/stream better way ([e26f05c](https://github.com/silentlamp/plugNmeet-server/commit/e26f05c79add85e26fc1a3bec7b2e9b564a4219d))
* panicking during conversion ([14967f4](https://github.com/silentlamp/plugNmeet-server/commit/14967f4189eceb086d8ed6cda636aa6bf89b20ec))
* periodically sync users and reconcile ([b6b361a](https://github.com/silentlamp/plugNmeet-server/commit/b6b361a182ad34542d4abf2385bbec01b5f26cc2))
* prevent concurrent uploading by API for the same room ([1302997](https://github.com/silentlamp/plugNmeet-server/commit/130299762ab86c28b29a9539a3dc8fc112f74bce))
* prevents a panic when sending to a closed channel ([40bc3ca](https://github.com/silentlamp/plugNmeet-server/commit/40bc3ca11c06580df6be23286e08f5f4996d9f87))
* race condition while closing app ([20dfe44](https://github.com/silentlamp/plugNmeet-server/commit/20dfe446e23dc3dac179bdb1d791be4164c71327))
* recording file size record ([8ad5b79](https://github.com/silentlamp/plugNmeet-server/commit/8ad5b798b77af29d890d85b9dfed0e3dac1e1855))
* **refactor:** adopt idiomatic fx for dependency management ([07dedb7](https://github.com/silentlamp/plugNmeet-server/commit/07dedb7807019d8ff8a44e503ddfe3531b26cc85))
* refactored the way `IsRoomActive` worked before ([5b4aa22](https://github.com/silentlamp/plugNmeet-server/commit/5b4aa22639e68a2cabd4b77684eb821f17557379))
* **refactor:** few optimization ([6053166](https://github.com/silentlamp/plugNmeet-server/commit/6053166d30d8f555b1e0f2ce061e52c4d90759a2))
* **refactor:** implemented multi pools hook script support ([fc7bf1c](https://github.com/silentlamp/plugNmeet-server/commit/fc7bf1cfe3a6bd8acac36f4f4561eaeca7564dc4))
* **refactor:** improved the way to handle recorder ([0aa95af](https://github.com/silentlamp/plugNmeet-server/commit/0aa95af64cac4a5fd68f60aaa9d3626f185e568b))
* **refactor:** migrate whiteboard & dataChannel to use nats core pub/sub for low latency as jetstream seems very slow ([e7c1663](https://github.com/silentlamp/plugNmeet-server/commit/e7c1663efe5450d98eec8fccc4fce850771c722a))
* **refactor:** moved all related code to `BootstrapModule` ([dbcc9c7](https://github.com/silentlamp/plugNmeet-server/commit/dbcc9c7d3f501dc8b14f8b3608036f34f9970a78))
* **refactor:** recorders will use single KV bucket ([c9115b9](https://github.com/silentlamp/plugNmeet-server/commit/c9115b95c5197d34dbf341057f0b1a4ce8be1cb5))
* **refactor:** refactored args to use struct for easy to read ([c092422](https://github.com/silentlamp/plugNmeet-server/commit/c0924226cfe289c6e66b99e30e7f78154fefec77))
* **refactor:** refactored args to use struct for easy to read ([274c08d](https://github.com/silentlamp/plugNmeet-server/commit/274c08d4dd1a6f2ab66181d071f49de12647b287))
* **refactor:** renamed to `hooks` in config ([1a59a6f](https://github.com/silentlamp/plugNmeet-server/commit/1a59a6f5c3023664c94563ca8dc3ca52984ec285))
* **refactor:** renamed to `hooks` in config ([91c62a9](https://github.com/silentlamp/plugNmeet-server/commit/91c62a9105628d0c366be8c935d8a41164579dfd))
* **refactor:** support for both `long-lived` and `one-shot` commands ([2ca5aab](https://github.com/silentlamp/plugNmeet-server/commit/2ca5aab23a16a29f7d55cf7d47f998de47ff143f))
* removed deprecated `speechServices` ([30c1c10](https://github.com/silentlamp/plugNmeet-server/commit/30c1c1043416819e51421968832267b5f3a5ecc2))
* replace `QEMU` with native runner ([71b497f](https://github.com/silentlamp/plugNmeet-server/commit/71b497f6c7183c8b368424d244d80494794a0d7f))
* replace BBB `%%CONFNAME%%` with correct value ([ade869b](https://github.com/silentlamp/plugNmeet-server/commit/ade869bd90a75d3d2816018f26781ba3ec3362fb))
* replaced by `fiber.Locals` ([bc178e6](https://github.com/silentlamp/plugNmeet-server/commit/bc178e63bbd5c2a93f5a915ac37ec46680cf1d4d))
* replaced with `c.RequestCtx()` ([cff65fb](https://github.com/silentlamp/plugNmeet-server/commit/cff65fb74202b0a91de6c42f492ddc46be7f6466))
* retrieve room files from cache as well ([ce91154](https://github.com/silentlamp/plugNmeet-server/commit/ce9115434dc89a5176a96bdedc63b9357484ff2e))
* reverted back restrictions ([7a75f1b](https://github.com/silentlamp/plugNmeet-server/commit/7a75f1b82628333a890fb44fefb14d7c951f4f98))
* reworked on `OnAfterRoomEnded` to handle session termination more efficiently ([7285ca3](https://github.com/silentlamp/plugNmeet-server/commit/7285ca3c323040e624acfec15f5349f71f73797a))
* rolled backed SDK version ([9c32bbd](https://github.com/silentlamp/plugNmeet-server/commit/9c32bbd8deea7b217b003632f2ec877572c00039))
* round filesize in 2 precision ([b0f4d92](https://github.com/silentlamp/plugNmeet-server/commit/b0f4d92a35c9422ea2f881e8f732f58465dddbcf))
* router for v3 where need to specify both `GET` and `HEAD` ([b74f2e7](https://github.com/silentlamp/plugNmeet-server/commit/b74f2e7be5536c6bd1ef05e95c1c0791e6d677e6))
* runtime nil pointer error ([9dbc161](https://github.com/silentlamp/plugNmeet-server/commit/9dbc161100221f18ef7529da0e20fdbbb2c5ef31))
* save original size ([1535d6b](https://github.com/silentlamp/plugNmeet-server/commit/1535d6b159ea3eabc5484b0c87d75b79e77c40a5))
* send proper http status code ([d47cb04](https://github.com/silentlamp/plugNmeet-server/commit/d47cb04a94a36fe25ab12ecff830972381ae3535))
* seperated mutex to avoid panic error ([366ef61](https://github.com/silentlamp/plugNmeet-server/commit/366ef6141552a22ce1a432c59b81778a09121a05))
* serve meet portal only at /login ([808ac0a](https://github.com/silentlamp/plugNmeet-server/commit/808ac0a50ea188f56512ac8e806ed436795cb767))
* set `attachment` manually ([7cdee60](https://github.com/silentlamp/plugNmeet-server/commit/7cdee604627db9da64f76b9c25444b739b2c0c98))
* SIP user name ([3c0107b](https://github.com/silentlamp/plugNmeet-server/commit/3c0107b02976ee9c97825a9e8b992bef8dc40ad4))
* temporary room data status should be `RoomStatusEnded` ([d873668](https://github.com/silentlamp/plugNmeet-server/commit/d87366858219b2660f55bada46f916c9f06d201d))
* the same summary was triggered multiple times ([f688b38](https://github.com/silentlamp/plugNmeet-server/commit/f688b383d70d8256d6a515116cc023cfaa172451))
* the value of `customIdentifier` can't be too long ([55990a6](https://github.com/silentlamp/plugNmeet-server/commit/55990a6addec2a8318e6edd3f54dcd947a048cf1))
* update `ToFixed` logic ([de0b8a2](https://github.com/silentlamp/plugNmeet-server/commit/de0b8a29229ace10548bbc460737d2f34b44fbd0))
* update BBB metadata to match with new format ([28c6a96](https://github.com/silentlamp/plugNmeet-server/commit/28c6a96832feeb18bef7e19e8c7c1d34d5afadf3))
* update local cache during update to prevent nats `watch` latency problem ([a540966](https://github.com/silentlamp/plugNmeet-server/commit/a540966edb1f60ede5b4c0fdeba825271502bea1))
* update messages ([1a7a64c](https://github.com/silentlamp/plugNmeet-server/commit/1a7a64cea50e4e75b6356650de9ef2602068a8db))
* update proto ([a33ff7b](https://github.com/silentlamp/plugNmeet-server/commit/a33ff7bd6b9c2a13c99a24bbdd04eec4672c1093))
* update status immediately ([5b38e03](https://github.com/silentlamp/plugNmeet-server/commit/5b38e0367301fe7743a150831175144fe77f2a5c))
* updated logic for `UploadBase64EncodedData` ([55d0599](https://github.com/silentlamp/plugNmeet-server/commit/55d0599439e8a1961532506dcdd333d9179a469a))
* upgrade gofiber v3 ([b5f2a3e](https://github.com/silentlamp/plugNmeet-server/commit/b5f2a3e42bbf3614895ad945962250ad9bc03f8f))
* upgrade to gofiber v3 ([90e176c](https://github.com/silentlamp/plugNmeet-server/commit/90e176c12d7c2b2a761bac7a875a97629d82c5a0))
* use `favicon` middleware ([1bc3eaa](https://github.com/silentlamp/plugNmeet-server/commit/1bc3eaa87a20ec96a60671947f991d0be3d87c4a))
* use `fx.In` for easy initialization ([eb4d1b1](https://github.com/silentlamp/plugNmeet-server/commit/eb4d1b106b97e1c88541e5f60905994c5778dc96))
* use `jetstream.InterestPolicy` as `Retention` ([212275a](https://github.com/silentlamp/plugNmeet-server/commit/212275a998609589ce3fbd824a21c9eb7589b394))
* use `mutool` `draw` command ([d4ba4af](https://github.com/silentlamp/plugNmeet-server/commit/d4ba4af68473b19d43885be5ed1e7190ad111731))
* use `Room-Id` as header value so that can include in signature validation ([0779ab0](https://github.com/silentlamp/plugNmeet-server/commit/0779ab09c4a41598d3e81f596b07d87c731a8253))
* use correct ARCH ([b2da2a5](https://github.com/silentlamp/plugNmeet-server/commit/b2da2a5f328d6d6e5cadb0d7854d3ed59f38ec49))
* use extension based for better reading code ([4a613cf](https://github.com/silentlamp/plugNmeet-server/commit/4a613cf156ee831649854441fcc61e043d1cdbf4))
* use hash with key expiration ([a2d3e9c](https://github.com/silentlamp/plugNmeet-server/commit/a2d3e9c5644d550738402bc05724ddb6094c325a))
* use latest image ([ce714ec](https://github.com/silentlamp/plugNmeet-server/commit/ce714ec79258431123312ddad99d072e67b20d15))
* use nats core pub/sub for high-performance, loss-tolerant events like `TRANSCRIPTION_OUTPUT_TEXT` ([90ef6d1](https://github.com/silentlamp/plugNmeet-server/commit/90ef6d14c81c56bc2ac60d6cf83881e7aaa62c34))
* use nats core pub/sub for high-performance, loss-tolerant events like `TRANSCRIPTION_OUTPUT_TEXT` ([0e59d7a](https://github.com/silentlamp/plugNmeet-server/commit/0e59d7ab9943f36a954fa2d513b5dcf252abc17d))
* use new status `RoomStatusTriggeredEnd` when triggered end ([b23fa36](https://github.com/silentlamp/plugNmeet-server/commit/b23fa367e72c6e4f7615473603de97c2f55a2787))
* use plain user info to avoid confusion ([0731e74](https://github.com/silentlamp/plugNmeet-server/commit/0731e745966a8540b9888c8d45302202ad824eeb))
* use proto to handle hooks code ([97c3bbd](https://github.com/silentlamp/plugNmeet-server/commit/97c3bbd49516d9a5490497618bc21d8b13e80cd7))
* use redis temporary storage to retrieve room info ([a9ce286](https://github.com/silentlamp/plugNmeet-server/commit/a9ce286b8fcb4ed633f65f2bf887276718085eb2))
* use same file path checking for all download type ([c2b25b5](https://github.com/silentlamp/plugNmeet-server/commit/c2b25b5617647ed06979329246aabb521b36e0b4))
* use sip provided name ([bfc1c24](https://github.com/silentlamp/plugNmeet-server/commit/bfc1c24557dc24b3bd434795372a3a0971e76861))
* use the same pattern ([92b4ea9](https://github.com/silentlamp/plugNmeet-server/commit/92b4ea9b007ada8725af041b976bca313accf253))
* use title to identify ([98b12bd](https://github.com/silentlamp/plugNmeet-server/commit/98b12bd4791ef6d16c71617ec6b9b961e36b192e))
* validate resumableIdentifier + made MakeSafeFilename less sensitive ([d4042e7](https://github.com/silentlamp/plugNmeet-server/commit/d4042e790caccf3e552f22cf01ed16f225aba0de))
* webhook data cleanup moved to defer of `PrepareToExportAnalytics` method ([2b909a6](https://github.com/silentlamp/plugNmeet-server/commit/2b909a66db539c7295ba347cc8952a71d9d7342f))
* yaml lib replaced with `goccy/go-yaml` ([f95709d](https://github.com/silentlamp/plugNmeet-server/commit/f95709d8ff68fc809f0960deb4300cf7cef2821a))
